-- Заполнение таблицы orders 10 000 случайными заказами
-- Статус выбирается случайным образом из массива ['pending', 'shipped', 'cancelled']
-- Дата создания - случайная дата в пределах последних 90 дней
...
-- Добавление шести записей в таблицу product - список сосисок с ценами и ссылками на изображения
...
-- Заполнение таблицы order_product 10 000 строк, связывающих заказы с товарами
-- Количество товара - случайное от 1 до 50
-- product_id выбирается случайным образом от 1 до 6
